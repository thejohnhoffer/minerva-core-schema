...
##### <a name="autogenerated_heading_14"></a>root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 2 > allOf > item 1 > path > path items
...
##### <a name="autogenerated_heading_15"></a>root > scenes > scenes items > allOf > item 1 > layout > classNames > classNames items
