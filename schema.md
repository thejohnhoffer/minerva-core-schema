...
| - [shape](#images_items_allOf_i1_shape )       | No      | object           | No         | -                                                                     | -                 |
|                                                |         |                  |            |                                                                       |                   |
...
##### <a name="images_items_allOf_i1_shape"></a>Property `root > images > images items > allOf > item 1 > shape`
...
| Property                                             | Pattern | Type        | Deprecated | Definition | Title/Description |
| ---------------------------------------------------- | ------- | ----------- | ---------- | ---------- | ----------------- |
| - [physical](#images_items_allOf_i1_shape_physical ) | No      | Combination | No         | -          | -                 |
| - [pixel](#images_items_allOf_i1_shape_pixel )       | No      | Combination | No         | -          | -                 |
|                                                      |         |             |            |            |                   |

##### <a name="images_items_allOf_i1_shape_physical"></a>Property `root > images > images items > allOf > item 1 > shape > physical`
...
| All of(Requirement)                                                     |
| ----------------------------------------------------------------------- |
| [Vec<"width"\|"height">](#images_items_allOf_i1_shape_physical_allOf_i0) |
| [Measure<"Millimeter">](#images_items_allOf_i1_shape_physical_allOf_i1) |
|                                                                         |

##### <a name="images_items_allOf_i1_shape_physical_allOf_i0"></a>Property `root > images > images items > allOf > item 1 > shape > physical > allOf > Vec<"width"\|"height">`
...
| Property                                                           | Pattern | Type   | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------ | ------- | ------ | ---------- | ---------- | ----------------- |
| - [height](#images_items_allOf_i1_shape_physical_allOf_i0_height ) | No      | number | No         | -          | -                 |
| - [width](#images_items_allOf_i1_shape_physical_allOf_i0_width )   | No      | number | No         | -          | -                 |
|                                                                    |         |        |            |            |                   |

##### <a name="images_items_allOf_i1_shape_physical_allOf_i0_height"></a>Property `root > images > images items > allOf > item 1 > shape > physical > allOf > item 0 > height`

| Type                      | `number`                                                                  |
| ------------------------- | ------------------------------------------------------------------------- |
|                           |                                                                           |

##### <a name="images_items_allOf_i1_shape_physical_allOf_i0_width"></a>Property `root > images > images items > allOf > item 1 > shape > physical > allOf > item 0 > width`

| Type                      | `number`                                                                  |
| ------------------------- | ------------------------------------------------------------------------- |
|                           |                                                                           |

##### <a name="images_items_allOf_i1_shape_physical_allOf_i1"></a>Property `root > images > images items > allOf > item 1 > shape > physical > allOf > Measure<"Millimeter">`

| Type                      | `object`                                                                  |
| ------------------------- | ------------------------------------------------------------------------- |
| **Defined in**            | #/definitions/Measure<"Millimeter">                                       |
|                           |                                                                           |

| Property                                                       | Pattern | Type             | Deprecated | Definition | Title/Description |
| -------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [unit](#images_items_allOf_i1_shape_physical_allOf_i1_unit ) | No      | enum (of string) | No         | -          | -                 |
|                                                                |         |                  |            |            |                   |

##### <a name="images_items_allOf_i1_shape_physical_allOf_i1_unit"></a>Property `root > images > images items > allOf > item 1 > shape > physical > allOf > item 1 > unit`
...
##### <a name="images_items_allOf_i1_shape_pixel"></a>Property `root > images > images items > allOf > item 1 > shape > pixel`
...
| All of(Requirement)                                                  |
| -------------------------------------------------------------------- |
| [Vec<"width"\|"height">](#images_items_allOf_i1_shape_pixel_allOf_i0) |
| [Measure<"ImagePixel">](#images_items_allOf_i1_shape_pixel_allOf_i1) |
|                                                                      |

##### <a name="images_items_allOf_i1_shape_pixel_allOf_i0"></a>Property `root > images > images items > allOf > item 1 > shape > pixel > allOf > Vec<"width"\|"height">`

| Type                      | `object`                                                                                        |
| ------------------------- | ----------------------------------------------------------------------------------------------- |
| **Same definition as**    | [images_items_allOf_i1_shape_physical_allOf_i0](#images_items_allOf_i1_shape_physical_allOf_i0) |
|                           |                                                                                                 |

##### <a name="images_items_allOf_i1_shape_pixel_allOf_i1"></a>Property `root > images > images items > allOf > item 1 > shape > pixel > allOf > Measure<"ImagePixel">`
...
| Property                                                    | Pattern | Type             | Deprecated | Definition | Title/Description |
| ----------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [unit](#images_items_allOf_i1_shape_pixel_allOf_i1_unit ) | No      | enum (of string) | No         | -          | -                 |
|                                                             |         |                  |            |            |                   |

##### <a name="images_items_allOf_i1_shape_pixel_allOf_i1_unit"></a>Property `root > images > images items > allOf > item 1 > shape > pixel > allOf > item 1 > unit`
...
### <a name="autogenerated_heading_6"></a>root > scenes > scenes items
...
| Property                                                      | Pattern | Type             | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [unit](#scenes_items_allOf_i1_camera_center_allOf_i1_unit ) | No      | enum (of string) | No         | -          | -                 |
|                                                               |         |                  |            |            |                   |

##### <a name="scenes_items_allOf_i1_camera_center_allOf_i1_unit"></a>Property `root > scenes > scenes items > allOf > item 1 > camera > center > allOf > item 1 > unit`
...
##### <a name="autogenerated_heading_7"></a>root > scenes > scenes items > allOf > item 1 > layers > layers items
...
##### <a name="autogenerated_heading_8"></a>root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 0 > allOf > item 1 > channels > channels items
...
##### <a name="autogenerated_heading_9"></a>root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 0 > allOf > item 1 > transfers > transfers items
...
##### <a name="autogenerated_heading_10"></a>root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 1 > allOf > item 1 > channels > channels items
...
##### <a name="autogenerated_heading_11"></a>root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 1 > allOf > item 1 > shaders > shaders items
...
| Property                                                                  | Pattern | Type             | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [intent](#scenes_items_allOf_i1_layers_items_anyOf_i2_allOf_i1_intent ) | No      | enum (of string) | No         | -          | -                 |
| - [path](#scenes_items_allOf_i1_layers_items_anyOf_i2_allOf_i1_path )     | No      | array of number  | No         | -          | -                 |
|                                                                           |         |                  |            |            |                   |
...
##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i2_allOf_i1_path"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 2 > allOf > item 1 > path`
...
| Each item of this array must be                                                | Description |
| ------------------------------------------------------------------------------ | ----------- |
| [path items](#scenes_items_allOf_i1_layers_items_anyOf_i2_allOf_i1_path_items) | -           |
|                                                                                |             |

##### <a name="autogenerated_heading_12"></a>root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 2 > allOf > item 1 > path > path items
...
| Property                                                                  | Pattern | Type             | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [intent](#scenes_items_allOf_i1_layers_items_anyOf_i3_allOf_i1_intent ) | No      | enum (of string) | No         | -          | -                 |
| - [text](#scenes_items_allOf_i1_layers_items_anyOf_i3_allOf_i1_text )     | No      | string           | No         | -          | -                 |
|                                                                           |         |                  |            |            |                   |
...
##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i3_allOf_i1_text"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 3 > allOf > item 1 > text`
...
| Property                                                                  | Pattern | Type             | Deprecated | Definition | Title/Description |
| ------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [intent](#scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_intent ) | No      | enum (of string) | No         | -          | -                 |
| - [origin](#scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_origin ) | No      | Combination      | No         | -          | -                 |
| - [size](#scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_size )     | No      | number           | No         | -          | -                 |
| - [text](#scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_text )     | No      | string           | No         | -          | -                 |
|                                                                           |         |                  |            |            |                   |
...
##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_origin"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 4 > allOf > item 1 > origin`
...
| All of(Requirement)                                                                                                                    |
| -------------------------------------------------------------------------------------------------------------------------------------- |
| [Vec<"x"\|"y">](#scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_origin_allOf_i0)                                                  |
| [Measure<"WidthRatio"\|"HeightRatio"\|"Millimeter"\|"ImagePixel">](#scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_origin_allOf_i1) |
|                                                                                                                                        |

##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_origin_allOf_i0"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 4 > allOf > item 1 > origin > allOf > Vec<"x"\|"y">`
...
##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_origin_allOf_i1"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 4 > allOf > item 1 > origin > allOf > Measure<"WidthRatio"\|"HeightRatio"\|"Millimeter"\|"ImagePixel">`

| Type                      | `object`                                                                                      |
| ------------------------- | --------------------------------------------------------------------------------------------- |
| **Same definition as**    | [scenes_items_allOf_i1_camera_center_allOf_i1](#scenes_items_allOf_i1_camera_center_allOf_i1) |
|                           |                                                                                               |

##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_size"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 4 > allOf > item 1 > size`

| Type                      | `number`                                                                  |
| ------------------------- | ------------------------------------------------------------------------- |
|                           |                                                                           |

##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i4_allOf_i1_text"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 4 > allOf > item 1 > text`
...
| Property                                                                      | Pattern | Type             | Deprecated | Definition | Title/Description |
| ----------------------------------------------------------------------------- | ------- | ---------------- | ---------- | ---------- | ----------------- |
| - [intent](#scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_intent )     | No      | enum (of string) | No         | -          | -                 |
| - [origin](#scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_origin )     | No      | Combination      | No         | -          | -                 |
| - [rotation](#scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_rotation ) | No      | number           | No         | -          | -                 |
| - [size](#scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_size )         | No      | number           | No         | -          | -                 |
|                                                                               |         |                  |            |            |                   |
...
##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_origin"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 5 > allOf > item 1 > origin`
...
| All of(Requirement)                                                                                                                    |
| -------------------------------------------------------------------------------------------------------------------------------------- |
| [Vec<"x"\|"y">](#scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_origin_allOf_i0)                                                  |
| [Measure<"WidthRatio"\|"HeightRatio"\|"Millimeter"\|"ImagePixel">](#scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_origin_allOf_i1) |
|                                                                                                                                        |

##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_origin_allOf_i0"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 5 > allOf > item 1 > origin > allOf > Vec<"x"\|"y">`
...
##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_origin_allOf_i1"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 5 > allOf > item 1 > origin > allOf > Measure<"WidthRatio"\|"HeightRatio"\|"Millimeter"\|"ImagePixel">`
...
##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_rotation"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 5 > allOf > item 1 > rotation`

| Type                      | `number`                                                                  |
| ------------------------- | ------------------------------------------------------------------------- |
|                           |                                                                           |

##### <a name="scenes_items_allOf_i1_layers_items_anyOf_i5_allOf_i1_size"></a>Property `root > scenes > scenes items > allOf > item 1 > layers > layers items > anyOf > item 5 > allOf > item 1 > size`
...
##### <a name="autogenerated_heading_13"></a>root > scenes > scenes items > allOf > item 1 > layout > classNames > classNames items
